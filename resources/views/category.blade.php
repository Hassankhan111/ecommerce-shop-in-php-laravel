                    ...
                    <div class="featured__controls">
                        <ul>
                            ...
                            @foreach ($brand as $brands)
                                <li class="brandli"><a
                                        href="{{ route('brand.show', $brands->brand_id) }}">{{ $brands->brand_name }}</li>
                            @endforeach
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-3 mix vegetables fastfood">
                            <div class="featured__item">
                                ...
                                <div class="featured__item__pic set-bg">
                                    <a
                                        href="{{ optional($products)->product_id ? url('productdetails', $products->product_id) : '#' }}">

                                        <img src="{{ optional($products)->product_img
                                        ? asset('storage/' . $products->product_img)
                                         : asset('storage/products/camra.png') }}"
                                            alt="{{ optional($products)->product_title ?? 'No Image' }}" class="img-fluid">
                                ...
                                <div class="featured__item__text">
                                    <h6>
                                        <a href="#">
                                            {{ optional($products)->product_desc ?? 'No Description' }}
                                        </a>
                                    </h6>

                                    <h5>
                                        Rs: {{ optional($products)->product_price ?? '0' }}
                                    </h5>
                                </div>
